...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 1.92 (foreground color: #b2b2af, background color: #f4f4ee, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
+                 "html": "<p class=\"mt-2\" style=\"font-family: var(--font-inter); font-size: 14px; color: var(--theme-text-secondary); background-color: var(--theme-backdrop); padding: 4px 12px; border-radius: 4px; opacity: 0; transform: translateY(15.8099px);\">189 Cards • 6 Decks • Unlimited Bad Takes</p>",
+                 "target": Array [
+                   "p:nth-child(5)",
+                 ],
+               },
...
+   Element has insufficient color contrast of 1.92 (foreground color: #b2b2af, background color: #f4f4ee, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<p class=\"mt-2\" style=\"font-family: var(--font-inter); font-size: 14px; color: var(--theme-text-secondary); background-color: var(--theme-backdrop); padding: 4px 12px; border-radius: 4px; opacity: 0; transform: translateY(15.8099px);\">189 Cards • 6 Decks • Unlimited Bad Takes</p>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
